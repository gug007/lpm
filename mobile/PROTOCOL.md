...
workStatus?: { state: "in_progress"|"blocked"|"done"|"custom", label?: string, emoji?: string, note?: string, since: unix MILLIS }
                          // a status the person set on a duplicate ("what I want done with this copy"), unlike
                          ...
                          // neither. Absent when the duplicate has no status. `since` is 0 when unknown
