...
// splitSSHFields honours double-quoted spans.
...
// dedupeSSHHosts keeps the first occurrence, matching ssh's first-match-wins
// precedence for repeated Host blocks.
