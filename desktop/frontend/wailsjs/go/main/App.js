// Tauri command bindings. Each export keeps its original PascalCase name
// (imported across the component files) and forwards to a snake_case Tauri
// command via invoke(); camelCase arg keys map to Rust snake_case params.
//
// Originally generated from the Wails v3 bindings by scripts/gen-tauri-bindings.mjs.
// That codegen (and its Wails input) was removed once the migration reached
// parity — this file is now maintained BY HAND. To add a command: add the
// #[tauri::command] fn in src-tauri/, list it in all_command_handlers!
// (generated_commands.rs), and add an `export function Name(...) { invoke(...) }`
// here with camelCase arg keys.
