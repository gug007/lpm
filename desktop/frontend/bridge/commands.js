...
export function DuplicateProject(name, desiredName, excludeUncommitted, reinstallDeps) {
  return invoke("duplicate_project", { name, desiredName, excludeUncommitted, reinstallDeps });
}
