  ...
  return (
    <section>
          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="mt-0.5">
              {!host.enabled ? (
                ...
                <StatusLine
                  tone="pending"
                  text={`Waiting for port ${host.port} — another copy of lpm may be using it`}
                  className="text-[12px]"
                />
              )}
            </div>
      ...
      <Group>
        ...
        {/* The invite takes the add row's place: it is that action mid-flight, and
            a separate card for it drops the list a screen further down. */}
        {pairing ? (
          <div
            className="px-4 py-4"
