...
export function HardDriveIcon({ size = 14 }: { size?: number } = {}) { return <svg {...iconProps} width={size} height={size}><line x1="22" y1="12" x2="2" y2="12" /><path d="M5.45 5.11 2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z" /><line x1="6" y1="16" x2="6.01" y2="16" /><line x1="10" y1="16" x2="10.01" y2="16" /></svg>; }
...
export function PanelTopIcon() { return <svg {...iconProps}><rect x="3" y="4" width="18" height="16" rx="2.5" /><line x1="3" y1="9" x2="21" y2="9" /></svg>; }
export function PanelBottomIcon() { return <svg {...iconProps}><rect x="3" y="4" width="18" height="16" rx="2.5" /><line x1="3" y1="15" x2="21" y2="15" /></svg>; }
...
export function SquarePenIcon({ size = 14 }: { size?: number } = {}) { return <svg {...iconProps} width={size} height={size}><path d="M12 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7" /><path d="M18.375 2.625a1 1 0 0 1 3 3l-9.013 9.014a2 2 0 0 1-.853.505l-2.873.84a.5.5 0 0 1-.62-.62l.84-2.873a2 2 0 0 1 .506-.852z" /></svg>; }
...
export function WorktreeIcon({ size = 14 }: { size?: number } = {}) { return <svg {...iconProps} width={size} height={size}><path d="M9 20H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h3.9a2 2 0 0 1 1.69.9l.81 1.2a2 2 0 0 0 1.67.9H20a2 2 0 0 1 2 2v5" /><circle cx="13" cy="12" r="2" /><path d="M18 19c-2.8 0-5-2.2-5-5v8" /><circle cx="20" cy="19" r="2" /></svg>; }
...
export function SourceControlIcon({ size = 14 }: { size?: number } = {}) { return <svg {...iconProps} width={size} height={size} strokeWidth={1.75}><circle cx="6" cy="5" r="2.5" /><circle cx="6" cy="19" r="2.5" /><circle cx="18" cy="8" r="2.5" /><path d="M6 7.5v9" /><path d="M18 10.5c0 4-5 4.7-8.5 5S6.4 16 6 16.5" /></svg>; }
...
export function GripVerticalIcon({ size = 14 }: { size?: number } = {}) { return <svg {...iconProps} width={size} height={size}><circle cx="9" cy="6" r="0.5" /><circle cx="9" cy="12" r="0.5" /><circle cx="9" cy="18" r="0.5" /><circle cx="15" cy="6" r="0.5" /><circle cx="15" cy="12" r="0.5" /><circle cx="15" cy="18" r="0.5" /></svg>; }
export function MousePointerClickIcon({ size = 14 }: { size?: number } = {}) { return <svg {...iconProps} width={size} height={size}><path d="M14 4.1 12 6" /><path d="m5.1 8-2.9-.8" /><path d="m6 12-1.9 2" /><path d="M7.2 2.2 8 5.1" /><path d="M9.037 9.69a.498.498 0 0 1 .653-.653l11 4.5a.5.5 0 0 1-.074.949l-4.349 1.041a1 1 0 0 0-.74.739l-1.04 4.35a.5.5 0 0 1-.95.074z" /></svg>; }
...
export function YoutubeIcon() { return <svg {...iconProps}><path d="M2.5 17a24.12 24.12 0 0 1 0-10 2 2 0 0 1 1.4-1.4 49.56 49.56 0 0 1 16.2 0A2 2 0 0 1 21.5 7a24.12 24.12 0 0 1 0 10 2 2 0 0 1-1.4 1.4 49.55 49.55 0 0 1-16.2 0A2 2 0 0 1 2.5 17" /><path d="m10 15 5-3-5-3z" /></svg>; }
...
export function SmartphoneIcon({ size = 14 }: { size?: number } = {}) { return <svg {...iconProps} width={size} height={size}><rect x="5" y="2" width="14" height="20" rx="2.5" /><path d="M11 18h2" /></svg>; }
...
// Two lobes, no cortex squiggle: at 14-15px the inner stroke closes up against
// the lobes and the glyph reads as a blob, so the silhouette carries it alone.
export function BrainIcon({ size = 14 }: { size?: number } = {}) { return <svg {...iconProps} width={size} height={size}><path d="M12 5a3 3 0 1 0-5.997.125 4 4 0 0 0-2.526 5.77 4 4 0 0 0 .556 6.588A4 4 0 1 0 12 18Z" /><path d="M12 5a3 3 0 1 1 5.997.125 4 4 0 0 1 2.526 5.77 4 4 0 0 1-.556 6.588A4 4 0 1 1 12 18Z" /></svg>; }
...
export function ClockIcon({ size = 18 }: { size?: number } = {}) { return <svg {...iconProps} width={size} height={size}><circle cx="12" cy="12" r="9" /><path d="M12 7v5l3 2" /></svg>; }
...
export function MoreHorizontalIcon() { return <svg {...iconProps} fill="currentColor" stroke="none"><circle cx="5" cy="12" r="1.5" /><circle cx="12" cy="12" r="1.5" /><circle cx="19" cy="12" r="1.5" /></svg>; }
export function CornerUpLeftIcon() { return <svg {...iconProps}><polyline points="9 14 4 9 9 4" /><path d="M20 20v-7a4 4 0 0 0-4-4H4" /></svg>; }
export function UserIcon() { return <svg {...iconProps}><circle cx="12" cy="8" r="4" /><path d="M20 21a8 8 0 0 0-16 0" /></svg>; }
