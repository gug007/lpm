...
// These will be auto-generated by Wails — stubbed for now
const api = {
  ListProjects: async (): Promise<ProjectInfo[]> => [],
  StartProject: async (_name: string, _profile: string): Promise<void> => {},
  StopProject: async (_name: string): Promise<void> => {},
  GetProject: async (_name: string): Promise<ProjectInfo> =>
    ({} as ProjectInfo),
};
