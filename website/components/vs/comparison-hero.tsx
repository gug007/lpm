    ...
    <section className="pt-[clamp(4.5rem,9.5vh,6.5rem)] pb-[clamp(1.25rem,3vh,2rem)] text-center">
      <div className="max-w-4xl mx-auto px-6">
        <div className="mb-1">
          <Link
            href={VS_BASE_PATH}
            className="inline-flex min-h-11 items-center justify-center gap-1.5 px-3 py-2 text-xs text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors duration-200"
          >
        ...
        {verdictLine && (
          <p className="mt-4 text-base sm:text-[17px] font-medium text-gray-900 dark:text-gray-100 max-w-xl mx-auto leading-relaxed">
            {verdictLine}
          </p>
        )}
