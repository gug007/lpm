...
// Pages that pass an App Store source turn the non-Mac branch into the iPhone
// companion's install button instead of a requires-a-Mac dead end.
export function HeroCta({
  ...
  if ((platform === "ipad" || platform === "unsupported") && appStoreSource) {
    return (
      <div className={`${SHELL} sm:flex-row sm:justify-center sm:gap-5`}>
        ...
        <p className="max-w-sm text-pretty text-center text-[13px] leading-relaxed text-gray-500 sm:max-w-xs sm:text-left dark:text-gray-400">
          ...
          follows your Mac&apos;s terminals and agents from iPhone or iPad. The
          desktop app needs a Mac: open lpm.cx there to download it.
        </p>
      </div>
    );
  }
