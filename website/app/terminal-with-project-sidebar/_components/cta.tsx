  ...
  return (
    <section className="py-20 text-center sm:py-24">
      <div className="mx-auto max-w-3xl px-6">
        <h2 className="bg-gradient-to-br from-gray-950 via-gray-800 to-gray-600 bg-clip-text text-3xl leading-[1.1] font-extrabold tracking-tight text-transparent sm:text-5xl dark:from-white dark:via-gray-100 dark:to-gray-400">
