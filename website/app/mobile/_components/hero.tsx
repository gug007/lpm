    ...
    <section className="pt-28 sm:pt-40 pb-12 sm:pb-20 text-center">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <p className="mt-6 text-base sm:text-lg text-gray-600 dark:text-gray-400 max-w-xl mx-auto leading-relaxed tracking-wide">
          The lpm iOS app pairs with lpm on your Mac and mirrors your terminals
          in real time — type into a running agent, start and stop projects, and
          get a nudge the moment Claude Code or Codex is waiting on you. The work
          still runs on your Mac; your phone is a live window into it.
        </p>
