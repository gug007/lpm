    ...
    <section className="py-20 sm:py-24 text-center">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <p className="mt-6 text-base sm:text-lg text-gray-400 dark:text-gray-500 max-w-xl mx-auto leading-relaxed tracking-wide">
          Download the native macOS app, open a project, and pair your iPhone in
          Settings → Mobile devices. Free, native, and yours — the work stays on
          your Mac, the control comes with you.
        </p>
